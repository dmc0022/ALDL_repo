...
module LCD_driver_core_shared_touch (
    ...
    localparam integer KP_ICON_X0 = 176;
    ...
    // LCD/game space is 320x240, but rotated touch X contribution lands in a 0..239 style range.
    // Scale it to full 0..319 horizontal game width so icon hitboxes line up with rendering.
    wire [17:0] scaled_touch_x = touch_y * 10'd320;
    wire [9:0]  game_touch_x_unclamped = scaled_touch_x / 10'd240;
    wire [9:0]  game_touch_x =
        (game_touch_x_unclamped > 10'd319) ? 10'd319 : game_touch_x_unclamped;
    ...
    wire in_temp_icon =
        ...
        (game_touch_y <  TEMP_ICON_Y0 + TEMP_ICON_H + ICON_HIT_MARGIN);
